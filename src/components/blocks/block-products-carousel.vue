...
<script lang="ts">
	...
	type BlockProductsCarouselLayout =
		| "grid-4"
		| "grid-4-sm"
		| "grid-5"
		| "horizontal";
	...
	const carouselBreakpointsByMobileGridColumns: {
		[columns: number]: SwiperOptions["breakpoints"];
	} = {
		1: {
	...
	export default class BlockProductsCarousel extends Vue {
		...
		@Prop({ type: String, default: () => "grid-4" })
		readonly layout!: BlockProductsCarouselLayout;
		@Prop({ type: Number, default: () => 1 })
		readonly mobileGridColumns!: BlockProductsCarouselMobileGridColumns;
		@Prop({ type: Number, default: () => 1 }) readonly rows!: number;
		@Prop({ type: Array, default: () => [] }) readonly products!: IProduct[];
		@Prop({ type: Array, default: () => [] })
		readonly groups!: BlockHeaderGroup[];
